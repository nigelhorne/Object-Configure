...
like($log_lines[0], qr/DEBUG: Log::Abstraction/, 'Logged debug message to file, set from configuration file');
...
like($log_lines[0], qr/DEBUG: Log::Abstraction/, 'Logged debug message to file, set from the environment');
